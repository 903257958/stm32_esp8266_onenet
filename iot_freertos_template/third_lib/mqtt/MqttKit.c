...
//	snprintf(topic_buf, sizeof(topic_buf), "$sys/%s/%s/dp/post/json", pro_id, dev_name);    // 数据流topic
    snprintf(topic_buf, sizeof(topic_buf), "$sys/%s/%s/thing/property/post", pro_id, dev_name); // 物模型topic
