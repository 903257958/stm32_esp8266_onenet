...
static int __esp8266_get_time_init(ESP8266Dev_t *dev);
static int __esp8266_get_beijing_time(ESP8266Dev_t *dev, uint16_t *year, uint8_t *month, uint8_t *day, uint8_t *hour, uint8_t *minute, uint8_t *second);
static int __esp8266_deinit(ESP8266Dev_t *dev);
...
static int __extract_time_from_buf(uint8_t *buf, Time_t *time);
...
int esp8266_init(ESP8266Dev_t *dev)
{
	...
	dev->get_time_init = __esp8266_get_time_init;
 ...
 * @return	0, 表示成功, 其他值表示失败
 ******************************************************************************/
static int __esp8266_get_beijing_time(	ESP8266Dev_t *dev, 
										uint16_t *year, 
										uint8_t *month, 
										uint8_t *day, 
										uint8_t *hour, 
